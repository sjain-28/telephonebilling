        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="div-action">
                    <button class="btn btn-info" data-toggle="modal" data-target="#addCategoryModal">Add a
                        Category</button>
                    <a href="editDelCategory.php" class="btn btn-danger" role="button">Edit / Remove Category</a>
            ...
            <form class="form-horizontal" id="submitCategoryForm" action="php_action/createCategory.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-warning" id="createCategoryBtn"
