    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div id="usernameForm">
                    <form action="php_action/changeUsernameC.php" method="post" class="form-horizontal"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-info" data-loading-text="Loading..."
                                        id="changeUsernameBtn">Update username</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
                ...
                <div id="passwordForm">
                    ...
                    <form action="php_action/changePasswordC.php" method="post" class="form-horizontal"
